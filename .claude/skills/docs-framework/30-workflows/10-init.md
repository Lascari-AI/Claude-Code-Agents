...
|------|-----------------|
| `docs/10-codebase/00-overview.md` | `.claude/skills/docs-framework/40-templates/20-L1-codebase-overview/10-generic.md` |

**Appendix Zone:**
| File | Template Source |
|------|-----------------|
| `docs/99-appendix/00-overview.md` | `.claude/skills/docs-framework/40-templates/30-L2-section-overview/10-generic.md` |
